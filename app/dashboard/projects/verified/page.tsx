...
//                         <p className="text-gray-600">{project.description}</p>
//                         <div className="flex space-x-4 mt-4">
//                             <Link href={`/dashboard/projects/verified/${project.id}`} passHref className="text-blue-600 hover:underline">
//                                 View
//                             </Link>
//                             <Link href={`/dashboard/projects/verified/${project.id}/edit`} passHref className="text-green-600 hover:underline">
//                                 Edit
//                             </Link>
//                             <button
