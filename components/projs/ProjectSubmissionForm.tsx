...
// import { axiosInstance } from "@/utils/supabase/axios";
// import { createClient as supabase } from "@/utils/supabase/client"; // Make sure you have the supabase client set up
...
//     description: Yup.string().required("Description is required"),
//     docs: Yup.mixed()
//         .nullable() // Make docs optional
//         .test("fileSize", "Each document should be less than 15 MB", (value) => {
//             if (!value) return true; // No file upload
//             return Array.from(value).every((file) => file.size <= 15 * 1024 * 1024);
//         }),
//     images: Yup.mixed()
//         .nullable() // Make images optional
//         .test("fileSize", "Each image should be less than 5 MB", (value) => {
//             if (!value) return true; // No file upload
//             return Array.from(value).every((file) => file.size <= 5 * 1024 * 1024);
//         }),
// });

// // Upload file function for Supabase
...
//             // Arrays to hold uploaded file paths
//             const docPaths: string[] = [];
//             const imagePaths: string[] = [];

//             // Upload docs
//             if (values.docs) {
//                 for (const doc of Array.from(values.docs)) {
//                     const path = await uploadFile("docs", doc);
//                     docPaths.push(path);
//                 }
//             }
...
//                     const path = await uploadFile("images", image);
//                     imagePaths.push(path);
//                 }
//             }

//             // Add docs and images paths to formData
//             formData.append("docs", JSON.stringify(docPaths));
...
//                         {/* Docs Upload */}
//                         <div>
//                             <label htmlFor="docs" className="block font-semibold">Upload Documents (Max 15 MB each)</label>
//                             <input
//                                 id="docs"
//                                 name="docs"
//                                 type="file"
...
//                                 onChange={(event) => setFieldValue("docs", event.currentTarget.files)}
//                             />
...
//                         {/* Images Upload */}
//                         <div>
//                             <label htmlFor="images" className="block font-semibold">Upload Images (Max 5 MB each)</label>
//                             <input
//                                 id="images"
//                                 name="images"
//                                 type="file"
